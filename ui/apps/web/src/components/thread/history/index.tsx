...
function ThreadList({
  ...
  return (
    <div className="h-full flex flex-col w-full gap-1 items-start justify-start overflow-y-scroll">
      {threads.map((t) => {
        ...
        return (
          <div key={t.thread_id} className="w-full px-1">
            <Button
              variant="ghost"
              className="text-left items-start justify-start font-normal w-[260px] text-[#cfc3a8] hover:bg-[#242018] hover:text-[var(--gold-bright)] font-console text-xs"
              onClick={(e) => {
                e.preventDefault();
...
export default function ThreadHistory() {
  ...
  return (
    <>
      <div className="hidden lg:flex flex-col hud-panel m-2 items-start justify-start gap-4 h-[calc(100vh-1rem)] w-[280px] shrink-0">
